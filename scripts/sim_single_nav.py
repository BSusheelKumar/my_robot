...
def main():
    ...
    initial_pose.pose.position.x = -0.29967716336250305
    initial_pose.pose.position.y = -0.0009105631615966558
    initial_pose.pose.orientation.z = 0.03092659537290271
    initial_pose.pose.orientation.w =  0.9995216584439983
    ...
    goal_pose.pose.position.x = 5.653504371643066
    goal_pose.pose.position.y = 2.7832412719726562
    goal_pose.pose.orientation.w = 0.7205151090486812
    ...
    while True:
        ...
        if data.value == '1':
            ...
            if result == TaskResult.SUCCEEDED:
                ...
                print('Goal failed!, Going to initial position')
                navigator.goToPose(initial_pose)
