...
class MyNode(Node):
    def __init__(self):
        ...
        self.next = self.create_subscription(String,"/next",self.next_callback,10)
    ...
    def camera_callback(self, data):
        if self.should_i_run == True:
            print("Starting search for fire")
            ...
            print("Waiting for 'start_searching' command before processing camera data.")
    def next_callback(self,msg):
        if msg.data == "start_searching":
